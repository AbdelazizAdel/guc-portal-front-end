...
export default function BasicTable() {
  ...
  useEffect(async () => {
    const LocationRes = axios.get("https://gucportalguc.herokuapp.com/HR/getCourse", {
      headers : {
  ...
  const handleClickDelete = async(id) => {
    const response = await axios.delete(`https://gucportalguc.herokuapp.com/HR/opCourse/${id}`,{
        headers : {
            auth_token : localStorage.getItem('auth_token')
        },
        data: {}
...
const handleClickUpdate = async(id) => {
    const response = await axios.post(`https://gucportalguc.herokuapp.com/HR/opCourse/${id}`,{
        headers : {
            auth_token : localStorage.getItem('auth_token')
        },
        data: {}
